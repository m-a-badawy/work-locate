...
router.post(
    ...
    [isAuth, isCustomer , validateObjectID('reservationId') , validationSchema(confirmArrivalValidation)],
    confirmArrival
)
...
router.put(
    ...
    [isAuth , validateObjectID('reservationId') , validationSchema(updateReservationValidation)], 
    updateReservation
);
